      ...
      <div className="service-card">
                ...
                index < 3 ? (
                  <div key={index}>
                    <li className="mb-3 md:flex" key={index}>
                      ...
                      <span className="text-[16px] font-normal">{card1.para[items]}</span>
                    </li>
                  </div>
                ) : (
                  <div key={index}>
        ...
        <div className="w-full card-2 flex items-center justify-between max-lg:flex-col  max-lg:my-10">
          <div
            ...
            data-aos-offset="200"
            data-aos-easing="ease-in-sine"
            className="card-bar h-[400px] w-10 bg-gray rounded-full max-lg:h-10 max-lg:w-full max-sm:rounded-t-lg max-lg:order-3"
          ></div>
          ...
          <div
            ...
            data-aos-offset="100"
            data-aos-easing="ease-in-sine"
            className="card-cnt px-5 w-3/5 bg-light_white flex flex-col items-center max-lg:w-[90%] max-sm:w-full max-lg:order-2"
          >
            <div className="flex items-center justify-center gap-5 my-5 max-sm:flex-col max-sm:my-5 max-sm:gap-2">
              <h4 className="text-center text-3xl font-[700] uppercase max-sm:text-2xl">
                {card2.title}
              </h4>
            </div>
                ...
                index < 2 ? (
                  <div key={index}>
                    <li className="mb-3 md:flex" key={index}>
                      ...
                      <span className="text-[16px] font-normal">{card2.para[items]}</span>
                    </li>
                  </div>
                ) : (
                  <div key={index}>
