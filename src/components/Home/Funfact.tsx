  ...
  return (
    <>
      <div className="sec-heading">
        <h4 className="text-center font-[700] pb-5 text-[30px] max-lg:mt-5">
          OUR ACHIVEMENTS
        </h4>
      </div>
<div className="flex items-center w-full max-lg:flex-col relative gap-[20px] max-lg: flex-cols px-[5%] max-lg:p-5 mb-10">
        <div className="grid grid-cols-2 gap-2 w-2/5 max-lg:w-full">
          ...
          <div className="bg-light_white inline-flex items-center justify-center w-full h-[230px]">
            <div className="flex flex-col">
              ...
              <p className="mt-2 uppercase text-center">Years of Trust</p>
            </div>
          </div>
