...
const Officeimg = () => {
  return (
    <div className="sec-padding w-full bg-light_white">
      <h4 className="text-center font-[700] pb-5 text-[30px] uppercase max-lg:mt-5 mb-6">
        OUR Infrastructure
      </h4>
      <div className="w-full h-[518px] max-lg:h-auto overflow-hidden">
        <div className="w-[90%] h-full max-lg:w-full max-lg:ml-0 flex justify-center ml-[5%] overflow-hidden">
          <LazyLoadImage
            src="/Aboutus/office_img_1.jpeg"
            alt="Office - workers"
            className="w-full h-full rounded-lg hover:scale-110 duration-300"
          />
        </div>
      </div>
