export const TwopostData = [
  {
    ...
    card_2: {
      img: "Product-Page/2-PostParking-2.webp",
      title: "benefits",
      para: {
    ...
    card_3: {
      img: "/Product-Page/2-PostParking-3.webp",
...
export const ShuttleData = [
  {
    ...
    card_3: {
      img: "Product-Page/shuttlestacker-3.webp",
      title: "Technical Specification",
      para: {
        "Maximum Lifting Capacity":
...
export const VerticalData = [
  {
    ...
    card_2: {
      ...
      para: {
        ...
        "Environmental Benefits": "Limits the natural space of parking area.",
      },
    },
    card_3: {
